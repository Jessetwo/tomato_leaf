...
class _InfoState extends State<Info> {
  ...
  static final List<Widget> _widgetList = <Widget>[
    Column(
      ...
      children: [
        Text("Cause of Disease", style: optionStyle1),
        const SizedBox(
          height: 10.0,
        ),
        const Text(
          """The disease is caused by four species of Xanthomonas (X. euvesicatoria, X. gardneri, X. perforans, and X. vesicatoria). All four bacteria are strictly aerobic, gram-negative rods with a long whip-like flagellum (tail) that allows them to move in water, which allows them to invade wet plant tissue and cause infection.""",
          textAlign: TextAlign.justify,
        ),
        const SizedBox(
          height: 10.0,
        ),
        Text("Prevention and Cure", style: optionStyle1),
        const Row(children: [
          Text('1) '),
          Expanded(
              child: Text(
    ...
    Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text("The Tomato Plant is healthy. No need to worry ",
            style: optionStyle1),
        const SizedBox(
          height: 10.0,
        ),
    ...
    Column(
      ...
      children: [
        ...
        const Text(
          """Late blight is a potentially devastating disease of tomato, infecting leaves, stems and fruits of plants. The disease spreads quickly in fields and can result in total crop failure if untreated. Late blight is caused by the oomycete Phytophthora infestans. Oomycetes are fungus-like organisms also called water molds, but they are not true fungi.""",
          textAlign: TextAlign.justify,
        ),
        const SizedBox(
          height: 10.0,
        ...
        const Row(children: [
          ...
          Expanded(
              child: Text(
            'Avoid planting tomatoes on sites that were previously in potatoes or close to potatoes.',
            textAlign: TextAlign.justify,
          ))
        ], crossAxisAlignment: CrossAxisAlignment.start),
        const Row(children: [
          ...
          Expanded(
              child: Text(
            ' Sequential planting or planting several crops of tomatoes over time will reduce the risk of late blight destroying all tomatoes at once.',
            textAlign: TextAlign.justify,
          ))
        ], crossAxisAlignment: CrossAxisAlignment.start),
        const Row(children: [
    ...
    Column(
      ...
      children: [
        ...
        const Text(
          """The two-spotted spider mite is the most common mite species that attacks vegetable and fruit crops.Outbreaks are often caused by the use of broad-spectrum insecticides which interfere with the numerous natural enemies that help to manage mite populations.""",
          textAlign: TextAlign.justify,
        ),
        const SizedBox(
          height: 10.0,
    ...
    Column(
      ...
      children: [
        ...
        const Text(
          """The fungus causes plants to lose their leaves; it is a major disease. If infection occurs before the fruit has developed, yields are low.""",
          textAlign: TextAlign.justify,
        ),
        const SizedBox(
          height: 10.0,
    ...
    Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text("The image you uploaded was not of tomato leaf",
            style: optionStyle1),
        const SizedBox(
          height: 10.0,
        ),
